      ...
      while menu == True:
         ...
         for event in events:
            if event.type == pygame.MOUSEBUTTONDOWN:
               ...
               if EASY.obj.collidepoint(mouse):
                  hn = "E"
               elif MEDIUM.obj.collidepoint(mouse):
                  hn = "M"
               elif HARD.obj.collidepoint(mouse):
                  hn = "H"
               elif E1.obj.collidepoint(mouse):
                  game = "Turtles"
                  par = 1
               elif E1.obj.collidepoint(mouse):
                  game = "Black hole"
                  par = 1
               elif E2.obj.collidepoint(mouse):
                  game = "Hole 1"
                  par = 2
         if not hn == "":
            if hn == "E":
